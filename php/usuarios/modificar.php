...
?>
<form action='/php/usuarios/enviarmodificacion.php' method='POST' class='formulario' enctype="multipart/form-data" onsubmit="return validaremail();" oninput="return validartelefono();">
  ...
  <h5>Complete los campos que quiera modificar</h5>
    ...
    <input type='hidden' maxlength="40" id="email" name='email'  value='<?php echo $usuario['email']?>' required>
